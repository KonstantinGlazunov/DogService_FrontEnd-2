		...
		<Carousel fade>
			<Carousel.Item>
				<div className={styles.caruselimgwrap}>
					<img className="d-block w-100" src={dog_1} alt="dog_1" />
					<img className="d-block w-100" src={dog_2} alt="dog_2" />
					<img className="d-block w-100" src={dog_3} alt="dog_3" />
					<img className="d-block w-100" src={dog_4} alt="dog_4" />
				</div>
          ...
          <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p> */}
			...
			<Carousel.Item>
				<div className={styles.caruselimgwrap}>
					<img className="d-block w-100" src={dog_5} alt="dog_5" />
					<img className="d-block w-100" src={dog_6} alt="dog_6" />
					<img className="d-block w-100" src={dog_7} alt="dog_7" />
					<img className="d-block w-100" src={dog_8} alt="dog_8" />
				</div>
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p> */}
			...
			<Carousel.Item>
				<div className={styles.caruselimgwrap}>
					<img className="d-block w-100" src={dog_9} alt="dog_9" />
					<img className="d-block w-100" src={dog_10} alt="dog_10" />
					<img className="d-block w-100" src={dog_11} alt="dog_11" />
					<img className="d-block w-100" src={dog_12} alt="dog_12" />
				</div>
